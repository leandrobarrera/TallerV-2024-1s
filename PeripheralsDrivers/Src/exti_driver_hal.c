...
static void exti_select_edge(EXTI_Config_t *extiConfig){
	...
	if(extiConfig->edgeType == EXTERNAL_INTERRUPT_RISING_EDGE){
	...
	else if(extiConfig->edgeType == EXTERNAL_INTERRUPT_FALLING_EDGE){
...
static void exti_config_interrupt(EXTI_Config_t *extiConfig){
	...
	case 6: {
		EXTI->IMR |= EXTI_IMR_MR6_Msk;
		break;
	}
	case 7: {
		EXTI->IMR |= EXTI_IMR_MR7_Msk;
		break;
	}
	case 8: {
		EXTI->IMR |= EXTI_IMR_MR8_Msk;
		break;
	}
	case 9: {
		EXTI->IMR |= EXTI_IMR_MR9_Msk;
		break;
	}
	case 10: {
		EXTI->IMR |= EXTI_IMR_MR10_Msk;
		break;
	}
	case 11: {
		EXTI->IMR |= EXTI_IMR_MR11_Msk;
		break;
	}
	case 12: {
		EXTI->IMR |= EXTI_IMR_MR12_Msk;
		break;
	}
	case 13: {
	...
	case 14: {
		EXTI->IMR |= EXTI_IMR_MR14_Msk;
		break;
	}
	case 15: {
		EXTI->IMR |= EXTI_IMR_MR15_Msk;
		break;
	}
	default: {
		__NOP();
