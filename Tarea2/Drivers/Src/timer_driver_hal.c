...
void timer_enable_clock_peripheral(Timer_Handler_t *pTimerHandler){
    ...
    /*al darle ctl + clic, nos lleva a la definicion del APB1, las mascaras que se aplican sobre el, etc.
     tener presente que este APB1 funciona para los Timers que se usan para esta entrega (2, 3 y 5), pero para posteriores sera necesario . *
     hacer esto mismo pero para APB2, el cual tiene unos ligeros cambios en el codigo*/
